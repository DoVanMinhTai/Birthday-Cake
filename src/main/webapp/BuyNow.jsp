...
<%
        ...
        double price = (double) session.getAttribute("BuyNowPrice");
...
<%--                <%= p.getSizePrices().get(0).getDiameter() %>--%>
<%--                <% } else { %>--%>
<%--                N/A--%>
<%--                <% } %>--%>
    <%=session.getAttribute("BuyNowPrice")%>
            ...
            <td><%= session.getAttribute("BuyNowQuantity") %></td>
    ...
    <div class="card p-4">
        ...
        <p>Phí vận chuyển: <span><%=123%></span></p>
        <p><strong>Tổng thanh toán: <span id="final-price"><%=nF.format(sumPay)%></span></strong></p>
    </div>
